...
class CategoryController extends Controller
{
    ...
    public function store(CategoryRequest $request, Category $model)
    {
        ...
        $category = $model->create($request->merge(['user' => auth()->user()->id, 'title_structure' => $title_structure])->all());
    ...
    public function update(CategoryRequest $request, Category $category)
    {
        ...
        $category->update($request->merge(['user' => auth()->user()->id, 'title_structure' => $title_structure])->all());
