                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <select class="selectpicker" onchange="onChangeModell();" data-style="select-with-transition" name="modell_id" id="modell_id" required="true">
                                                <option value=""></option>
                                                @foreach($modells as $item)
                                                    <option class="modell_{{ $item->id }}" value="{{ $item->id }}" {{ $item->id == old('modell_id', $deal->modell_id) ? 'selected' : '' }} style="display:none;">{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
