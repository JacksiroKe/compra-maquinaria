@extends('layouts.app', ['activePage' => 'modell-management', 'menuParent' => 'characteristics', 'titlePage' => __('Model
Management')])
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('modell.update', $modell) }}" autocomplete="off"
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('name', $modell->name) }}" required="true"
                                            aria-required="true" />
