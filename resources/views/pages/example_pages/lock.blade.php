@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'classPage' => 'lock-page', 'activePage' => 'lock', 'title' => __('Compra Maquinaria'), 'pageBackground' => asset("material").'/img/lock.jpg'])
