@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'classPage' => 'pricing-page', 'activePage' => 'pricing', 'title' => __('Compra Maquinaria'), 'pageBackground' => asset("material").'/img/bg-pricing.jpg'])
